    ...
    >
      ...
      <div className="space-y-1">
        <div className="text-xs text-muted-foreground/70 font-mono flex gap-2">
          ...
          <span className="text-foreground/90">{proxy.server}:{proxy.port}</span>
        </div>
      ...
      <div className="flex items-center justify-center gap-2 pt-2 border-t border-white/5">
        <div className="relative flex items-center justify-center">
          ...
          <div className={`w-2 h-2 rounded-full ${isOnline ? 'bg-green-500 shadow-[0_0_8px_2px_rgba(34,197,94,0.6)]' : 'bg-red-500'}`} />
        </div>
